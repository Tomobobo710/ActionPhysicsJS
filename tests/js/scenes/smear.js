(function (Runner, U, AP) {
	...
	Runner.test('smear', 'tilted box on a support does not hang frozen mid-air', function (t) {
		...
		var box = t.box(w, HALF, HALF, HALF, 2, {
			pos: [0.21, 0.9 + 2.92, 0.017], rot: SEED_Q, color: '#e0b020'
		});
		...
		description:
			...
			"up at head height (tiny velocity and spin, held by a persistent multi-point contact whose normal " +
			"points nearly straight down) instead of rolling off — a contact-solver hang."
	});
})(
